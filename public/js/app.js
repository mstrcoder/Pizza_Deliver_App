...
var cart = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(session) {
    var res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            Object(_notification_js__WEBPACK_IMPORTED_MODULE_2__["notification"])("error", " Please Login To Add item to cart");
...
/* harmony import */ var _status__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./status */ "./resources/js/status.js");
...
var status = document.querySelector("#hiddenInput") ? document.querySelector("#hiddenInput").value : null; // const login = document.querySelector(".login");
...
add.forEach(function (x) {
  x.addEventListener("click", function (e) {
    e.preventDefault();
    var val = JSON.parse(x.getAttribute("data-pizza"));
    val.qty = 1;
    Object(_notification_js__WEBPACK_IMPORTED_MODULE_1__["notification"])("success", "Item Added To Cart!");
    var flag = 0;
...
if (status) {
  Object(_status__WEBPACK_IMPORTED_MODULE_3__["Order_status"])(JSON.parse(status));
...
var Order_status = function Order_status(order) {
  var flag = true;
  var show = document.querySelectorAll(".status_line");
  ...
  show.forEach(function (i) {
    ...
    if (i.dataset.status === order.status) {
      ...
      var dates = "".concat(date.getHours(), ":").concat(date.getMinutes());
...
__webpack_require__(/*! /Users/apple/Desktop/Pizza_Deliver_App/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/apple/Desktop/Pizza_Deliver_App/resources/scss/app.scss */"./resources/scss/app.scss");
